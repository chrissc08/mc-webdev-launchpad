...
const packages = [
  {
    ...
    features: ["1 page", "No navigation bar", "Up to 8 elements", "Mobile-responsive", "Unlimited revisions"],
    popular: false,
  },
  {
    name: "Standard",
  ...
  },
  {
    ...
    features: ["CMS integration", "Blog / portfolio / testimonials", "Advanced sections", "Conversion optimization", "Unlimited revisions"],
    popular: false,
  },
];
